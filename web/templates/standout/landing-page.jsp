<%@ page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    ================================================== -->
        <link rel="shortcut icon" href="${pageContext.request.contextPath}/templates/standout/favicon.ico"
            type="image/x-icon">
        <link rel="icon" href="${pageContext.request.contextPath}/templates/standout/favicon.ico" type="image/x-icon">
        ...
        <section id="about" class="s-about target-section">
            ...
            <div class="row section-header narrower align-center" data-aos="fade-up">
                <div class="col-full">
                    ...
                    <p class="lead">
                        ${aboutDesc != null ? aboutDesc : 'Manage campaigns, track leads, and automate your marketing
            ...
            <div class="row bit-narrow features block-1-2 block-mob-full">
                ...
                <div class="col-block item-feature" data-aos="fade-up">
                    ...
                    <div class="item-feature__text">
                        ...
                        <p>${featureDesc2 != null ? featureDesc2 : 'Watch your campaign performance live. Visual cues
                ...
                <div class="col-block item-feature" data-aos="fade-up">
                    ...
                    <div class="item-feature__text">
                        ...
                        <p>${featureDesc3 != null ? featureDesc3 : 'Nemo cupiditate ab quibusdam quaerat impedit magni.
                ...
                <div class="row testimonials">
                    ...
                    <div class="col-full slick-slider testimonials__slider">
                        ...
                        <div class="testimonials__slide">
                            ...
                            <p>Intuitive interface and powerful automation tools. A must-have for any sales team.</p>
                        </div> <!-- end testimonials__slide -->
        ...
        <section id="contact" class="s-pricing target-section">
            ...
            <div class="row" data-aos="fade-up">
                <div class="col-full">
                    ...
                    <!-- Contact Form -->
                    <form id="contactForm" method="POST" action="${pageContext.request.contextPath}/lp/submit"
                        class="contact-form">
                        <input type="hidden" name="landingPageId" value="${landingPageId}">

                        <div class="form-field">
                            <input name="fullName" type="text" id="contactName" placeholder="Your Name *" required>
                        </div>

                        <div class="form-field">
                            <input name="email" type="email" id="contactEmail" placeholder="Your Email *" required>
                        </div>
                        ...
                        <div class="form-field">
                            <button type="submit" class="btn btn--primary large full-width">Send Message</button>
                        </div>
