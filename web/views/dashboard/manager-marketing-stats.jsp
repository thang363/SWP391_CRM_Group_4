...
<div class="container-fluid pt-4 px-4">
    ...
    <div class="row g-4 mb-4">
        <!-- Card 4: Total Budget -->
        <div class="col-sm-6 col-xl-4">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4 shadow-sm border-start border-info border-5">
                <i class="fa fa-wallet fa-3x text-info"></i>
                <div class="ms-3 text-end">
                    <p class="mb-2 text-muted small uppercase fw-bold">Tổng Ngân sách</p>
                    <h3 class="mb-0 fw-bold"><fmt:formatNumber value="${stats.totalBudget}" type="currency" currencySymbol="₫"/></h3>
                </div>
            </div>
        </div>
        <!-- Card 5: Pipeline Value -->
        <div class="col-sm-6 col-xl-4">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4 shadow-sm border-start border-secondary border-5">
                <i class="fa fa-chart-line fa-3x text-secondary"></i>
                <div class="ms-3 text-end">
                    <p class="mb-2 text-muted small uppercase fw-bold">Giá trị dự kiến</p>
                    <h3 class="mb-0 fw-bold"><fmt:formatNumber value="${stats.personalPipelineValue}" type="currency" currencySymbol="₫"/></h3>
                </div>
            </div>
        </div>
