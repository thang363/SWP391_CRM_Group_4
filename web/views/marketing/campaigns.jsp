                                                    ...
                                                    <c:forEach var="campaign"
                                                        ...
                                                        <tr
                                                            ...
                                                            <td class="table-actions">
                                                                <c:choose>
                                                                    <c:when test="${not campaign.isOwner}">
                                                                        <button
                                                                            class="btn btn-sm btn-secondary"
                                                                            disabled
                                                                            title="Bạn không có quyền chỉnh sửa chiến dịch của người khác">
                                                                            <i
                                                                                class="fa fa-edit"></i>
                                                                        </button>
                                                                    </c:when>
                                                                    ...
                                                                    <c:otherwise>
                                                                        <button
                                                                            ...
                                                                            data-id="${campaign.id}"
                                                                            onclick="editCampaign(this.getAttribute('data-id'))"
                                                                            title="Chỉnh sửa">
                                                                            <i
                                                                                class="fa fa-edit"></i>
                                                                        </button>
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${not campaign.isOwner}">
                                                                        <button
                                                                            class="btn btn-sm btn-secondary"
                                                                            disabled
                                                                            title="Bạn không có quyền xóa chiến dịch của người khác">
                                                                            <i
                                                                                class="fa fa-trash"></i>
                                                                        </button>
                                                                    </c:when>
                                                                    ...
                                                                    <c:otherwise>
                                                                        <button
                                                                            ...
                                                                            onclick="handleDeleteCampaign(this)"
                                                                            title="Xóa">
                                                                            <i
                                                                                class="fa fa-trash"></i>
                                                                        </button>
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${not campaign.isOwner}">
                                                                        <button
                                                                            class="btn btn-sm btn-secondary"
                                                                            disabled
                                                                            title="Bạn không có quyền chuyển giao chiến dịch của người khác">
                                                                            <i
                                                                    ...
                                                                    <c:otherwise>
                                                                        <button
                                                                            ...
                                                                            data-id="${campaign.id}"
                                                                            data-name="${campaign.name}"
                                                                            onclick="handleOpenTransferModal(this)"
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${not campaign.isOwner}">
                                                                        <button
                                                                            class="btn btn-sm btn-secondary"
                                                                            disabled
                                                                            title="Bạn không có quyền xem LP của người khác">
                                                                            <i
                                        ...
                                        <ul class="pagination justify-content-center">
                                            <li
                                                ...
                                                <button class="page-link"
                                                        data-page="${currentPageNumber - 1}" onclick="goToPage(this.getAttribute('data-page'))"
                                            ...
                                            <c:forEach begin="1" end="${totalPages}"
                                                ...
                                                <li
                                                    ...
                                                    <button class="page-link"
                                                            data-page="${i}" onclick="goToPage(this.getAttribute('data-page'))">${i}</button>
                                                </li>
                                            </c:forEach>
                                            <li
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="campaignBudget"
                                           name="budget" min="0" max="1000000000000" step="1000" value="0">
                                </div>
                            </div>
