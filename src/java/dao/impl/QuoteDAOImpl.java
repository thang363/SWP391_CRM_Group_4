...
public class QuoteDAOImpl implements QuoteDAO {
    ...
    @Override
    public List<Quote> getByOpportunityId(long opportunityId) {
    ...
    @Override
    public long create(long opportunityId, String subject, BigDecimal grandTotal, LocalDate validUntil, long createdBy) {
    ...
    @Override
    public void accept(long quoteId, long opportunityId) {
    ...
    @Override
    public boolean hasActiveSent(long opportunityId) {
    ...
    private Quote mapRow(ResultSet rs) throws SQLException {
        ...
        q.setOpportunityId(rs.getLong("opportunity_id"));
