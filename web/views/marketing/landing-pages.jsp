                            ...
                            <div class="bg-light rounded h-100 p-4">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <h4 class="mb-0">
                                                <i class="fa fa-file-code me-2"></i>Chỉnh sửa Landing Page
                                            </h4>
                                        </c:otherwise>
                                    </c:choose>
                                    ...
                                    <c:if test="${isManager}">
                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                            ...
                                            <i class="fa fa-plus me-2"></i>Giao LP
                                        </button>
                                    </c:if>
                                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="fa fa-plus-circle me-2"></i>giao LandingPage cho marketing</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="submitCreateLP()">
                            <i class="fa fa-paper-plane me-2"></i>Giao LP
                        </button>
                    </div>
                </div>
            </div>
