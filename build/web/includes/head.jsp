<%-- head.jsp - Dùng chung cho tất cả các trang --%>
    <meta charset="utf-8">
    ...
    <!-- Icon Font Stylesheet (using unpkg CDN) -->
    <link href="https://unpkg.com/@fortawesome/fontawesome-free@5.10.0/css/all.min.css" rel="stylesheet">
